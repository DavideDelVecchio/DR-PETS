...
def evaluate(pole_lengths, lambda_penalty, num_episodes=5):
...
plt.title("PETS vs DR-PETS under Pole Length Variations (95% CI)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("outputs/results/pole_length_comparison_cpu_ci.png")
print("Saved plot with confidence intervals to outputs/results/pole_length_comparison_cpu_ci.png")
